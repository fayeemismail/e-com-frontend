    ...
    return (
      <div className="min-h-screen bg-white pb-20 animate-[fadeIn_0.5s_ease-out]">
        ...
        <div className="px-5 sm:px-8 md:px-12 pt-16 max-w-2xl mx-auto text-center">
          ...
          {/* Order Details Card */}
          <div className="border border-[#e8e6e2] rounded-sm text-left mb-10 overflow-hidden">
            <div className="bg-[#faf9f7] px-6 py-4 border-b border-[#e8e6e2] flex flex-wrap justify-between items-center gap-2">
              ...
              <div className="text-right">
                ...
                <span className="inline-block text-[9px] tracking-[0.14em] uppercase bg-[#e8e6e2] text-[#1a1a1a] px-2 py-0.5 mt-0.5 rounded-xs font-medium">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/" className="bg-[#1a1a1a] text-white text-[11px] tracking-[0.16em] uppercase px-8 py-4 hover:bg-[#333] transition-colors rounded-sm text-center">
              Continue Shopping
            </Link>
          </div>
        </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            {step === 0 && (
              <div>
                ...
                <button onClick={handleContinueToPayment} className="w-full sm:w-auto bg-[#1a1a1a] text-white text-[11px] tracking-[0.16em] uppercase px-10 py-4 hover:bg-[#333] transition-colors rounded-sm">
                  Continue to Payment
                </button>
              </div>
            )}
                  ...
                  <div className="flex gap-3 mb-6">
                    {[
                      ...
                      <button
                        ...
                        className={`text-[10px] tracking-[0.14em] uppercase px-4 py-2 border transition-colors rounded-sm ${
                          paymentMethod === id
            ...
            {step === 2 && (
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button onClick={() => setStep(1)} disabled={isPlacingOrder} className="sm:w-auto text-[11px] tracking-[0.16em] uppercase px-8 py-4 border border-[#e8e6e2] text-[#9a9a94] hover:border-[#1a1a1a] hover:text-[#1a1a1a] transition-colors rounded-sm cursor-pointer bg-transparent disabled:opacity-50 disabled:cursor-not-allowed">
                    ← Back
                  </button>
                  <button
                    onClick={handlePlaceOrder}
                    disabled={isPlacingOrder}
                    className="grow sm:grow-0 bg-[#1a1a1a] text-white text-[11px] tracking-[0.16em] uppercase px-10 py-4 hover:bg-[#333] transition-colors rounded-sm cursor-pointer disabled:bg-[#9a9a94] disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isPlacingOrder ? (
                      <>
                ...
                {orderError && (
                  <div className="mt-4 p-4 border border-[#d32f2f]/20 bg-[#d32f2f]/5 text-[#d32f2f] text-xs rounded-sm font-light tracking-wide">
                    {orderError}
                  </div>
                )}
