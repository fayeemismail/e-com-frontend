    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-[#e8e6e2] h-13 flex items-center px-4 md:px-6">
        ...
        <div className="flex items-center gap-3 md:gap-5 flex-1 justify-end">
          ...
          {/* Admin Dashboard / Logout shortcut */}
          {isAdminAuthenticated && (
            <div className="flex items-center gap-3 border-l border-[#e8e6e2] pl-3 ml-1">
              <Link
                href="/admin/dashboard"
                className="text-[10.5px] tracking-[0.14em] uppercase text-[#1a1a1a] font-medium no-underline hover:opacity-60 transition-opacity"
              >
                Admin
              </Link>
              <button
                ...
                className="flex items-center gap-1 bg-transparent border-none cursor-pointer p-0 text-red-600 hover:opacity-60 transition-opacity text-[10.5px] font-medium tracking-[0.14em] uppercase"
              >
                Sign Out
              </button>
            </div>
              ...
              <>
                ...
                <li>
                  <button
                    ...
                    className="w-full text-left flex items-center gap-3 px-6 py-4 text-[13px] tracking-[0.12em] uppercase text-red-600 
                    bg-transparent border-none cursor-pointer border-b border-[#f0eeea] hover:bg-[#fafaf9] transition-colors duration-150"
                  >
                    <svg
                      width="14"
